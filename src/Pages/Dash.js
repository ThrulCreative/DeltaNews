                ...
                <div className="dash-body">
                        ...
                        <div className="dash-flex">
                            <div className="dash-radio-buttons">
                                <FormControl component="fieldset">
                                    ...
                                    >
                                        <FormControlLabel value={category} onChange={e => setCategory(e.target.value)} value="politics" control={<Radio />} label="Politics" />
                                        <FormControlLabel value={category} onChange={e => setCategory(e.target.value)} value="sports" control={<Radio />} label="Sports" />
                                        <FormControlLabel value={category} onChange={e => setCategory(e.target.value)} value="business" control={<Radio />} label="Business" />
                                        <FormControlLabel value={category} onChange={e => setCategory(e.target.value)} value="science & Tech" control={<Radio />} label="Science & Tech" />
                                        <FormControlLabel value={category} onChange={e => setCategory(e.target.value)} value="entertainment" control={<Radio />} label="Entertainment" />
                                    </RadioGroup>
                                </FormControl>
                            </div>
                    ...
                    <div className="dash-upload">
                        ...
                        <div className="upload-div">
                            ...
                            <input value={writer} onChange={e => setWriter(e.target.value)} style={{ opacity: "45%" }} className="dash-para" type="text" style={{ marginLeft: '42px' }} />
                        </div>
                    </div>
                </div>
